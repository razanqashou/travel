...
function showbar(){
    ...
    // بدلت iconsearch => icon (x)
    searchBtn.classList.toggle("fa-times")
    // on click iconsearch show search bar 
    // active (in css)
    // active => it is form inside the header
...
// FOREACH LOOPING INSIDE vidBtn(HAVE 5 VIDOE) (LENGHT =5)
